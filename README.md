...
For more information, tutorials, and updates, visit [guidelabs.ai](https://www.guidelabs.ai). Full model description is available in our paper: [Scaling Inherently Interpretable Language Models](https://www.guidelabs.ai/papers/scaling-inherently-interpretable-language-models.pdf).
...
There is also a [search_concepts.ipynb](notebooks/search_concepts.ipynb) notebook for browsing the concept vocabulary. Concept labels are downloaded automatically from the [HF Hub](https://huggingface.co/guidelabs/steerling).
